...
let  program = new anchor.Program(IDL as unknown as anchor.Idl, PREDICTION_ID);

interface OracleResUpdatedEvent {
    oracleRes: number | string;
    [key: string]: any;
}

const OracleEvent = program.addEventListener("OracleResUpdated", (event: OracleResUpdatedEvent, slot, signature) => {
