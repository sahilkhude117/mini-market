...
export type CloseInput<
  ...
  TAccountMinimarket extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountMinimarket>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountMinimarket> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.minimarket),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountMinimarket>;
